...
class OrderItem(models.Model):
    ...
    def products_price(self):
        ...
        if self.product and self.configuration:
            ...
            total_price = self.product.sell_price + self.configuration.get_price()
        elif self.product:
            ...
            total_price = self.configuration.get_price()
        else:
            logging.warning(
                f"Product and Configuration are None for order ID {self.id}"
            )
        ...
        if self.product:
            ...
            return total_price * self.configuration.available_quantity
